...
import com.xdev.expy.core.helper.reminder.ReminderReceiver;
import com.xdev.expy.core.helper.textwatcher.ExpiryDateTextWatcher;
import com.xdev.expy.core.helper.textwatcher.OpenedDateTextWatcher;
import com.xdev.expy.core.helper.textwatcher.PaoTextWatcher;
import com.xdev.expy.core.helper.textwatcher.ProductNameTextWatcher;
...
import static com.xdev.expy.core.util.DateUtils.DATE_FORMAT;
import static com.xdev.expy.core.util.DateUtils.addDay;
import static com.xdev.expy.core.util.DateUtils.differenceOfDates;
...
public class AddUpdateFragment extends Fragment implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (isUpdate) {
            ...
            binding.switchFinished.setChecked(product.isFinished);
        } else {
