...
import com.xdev.expy.core.util.ImageUtils;
...
public class RemoteDataSource {
    ...
    public void insertProduct(@NonNull ProductEntity product) {
    ...
    public void updateProduct(@NonNull ProductEntity product) {
        MutableLiveData<ApiResponse<Boolean>> result = new MutableLiveData<>();
        result.postValue(ApiResponse.loading(null));
    ...
    public LiveData<ApiResponse<String>> uploadImage(Context context, Uri uriPath, String storagePath, String fileName) {
        ...
        byte[] image = ImageUtils.uriToByteArray(context, uriPath);
        image = ImageUtils.compressByteArray(image, true);
